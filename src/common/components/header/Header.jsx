  ...
  return (
    <div
      ...
      style={{
        ...
        color: isToggled ? Constants.Colors.white : Constants.Colors.black,
      }}
    >
      {text}
    </div>
        ...
        <div style={{ flex: 1, display: "flex", alignItems: "center" }}>
          {showBackButton && (
            ...
            >
              ...
              >
                <path
                  d="M9.65985 0.348553C9.55275 0.238067 9.42552 0.150408 9.28544 0.0905973C9.14536 0.0307868 8.99519 0 8.84352 0C8.69186 0 8.54169 0.0307868 8.40161 0.0905973C8.26153 0.150408 8.1343 0.238067 8.02719 0.348553L0.269752 8.33074C0.184242 8.41854 0.116401 8.52284 0.0701132 8.63766C0.0238255 8.75248 0 8.87557 0 8.99987C0 9.12418 0.0238255 9.24726 0.0701132 9.36208C0.116401 9.4769 0.184242 9.5812 0.269752 9.66901L8.02719 17.6512C8.47917 18.1163 9.20787 18.1163 9.65985 17.6512C10.1118 17.1861 10.1118 16.4363 9.65985 15.9712L2.88939 9.00462L9.66908 2.02851C10.1118 1.56344 10.1118 0.813627 9.65985 0.348553Z"
                  fill="white"
                />
              </svg>
            </div>
