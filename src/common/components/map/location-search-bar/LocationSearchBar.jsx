...
export const LocationSearchBar = ({ onLocationChange }) => {
  const map = useMap();
  ...
  return (
    <div className={styles.locationSearchBarContainer}>
        ...
        >
          {!isLoading ? (
            ...
            >
              ...
              <path
                d="M23.9998 33.3333C29.1545 33.3333 33.3332 29.1546 33.3332 24C33.3332 18.8453 29.1545 14.6666 23.9998 14.6666C18.8452 14.6666 14.6665 18.8453 14.6665 24C14.6665 29.1546 18.8452 33.3333 23.9998 33.3333Z"
                stroke="white"
                strokeWidth="2"
              />
              <path
                d="M24.0002 26.6667C25.4729 26.6667 26.6668 25.4728 26.6668 24C26.6668 22.5273 25.4729 21.3334 24.0002 21.3334C22.5274 21.3334 21.3335 22.5273 21.3335 24C21.3335 25.4728 22.5274 26.6667 24.0002 26.6667Z"
                fill="white"
                stroke="white"
                strokeWidth="2"
              />
              <path
                d="M24 14.6667V12M33.3333 24H36M24 36V33.3333M12 24H14.6667"
                stroke="white"
                strokeWidth="2"
                strokeLinecap="round"
              />
