...
import { LocationSearchBar } from "../map/location-search-bar/LocationSearchBar";

import { Polygon } from "../map/polygon/Polygon";

import { MapApi } from "api";

import styles from "./ServiceCenterMapSelect.module.css";
      ...
      {selectedPlace && (
        <div className={styles["zone-selection-container"]}>
          ...
          <div className={styles["content-container"]}>
            ...
            {[
              ...selectedHexagons,
              ...Array(7 - selectedHexagons.length).fill(null),
            ].map((hex, index) =>
              !hex ? (
                ...
                <div key={hex} className={styles["zone-selected"]}>
                  <div>
                    <div className={styles["zone-index"]}>{index + 1}</div>Zone:{" "}
                    {hex}
                  </div>
                  <svg
