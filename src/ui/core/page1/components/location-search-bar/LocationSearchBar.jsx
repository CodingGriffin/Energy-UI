  ...
  return (
    <>
      ...
      { isSearching &&
        <div
          ref={searchBoxRef}
          className={styles.locationSearchBarContainer + (isSearching ? ` ${styles.locationSearchBarContainerActive}` : "")}>
